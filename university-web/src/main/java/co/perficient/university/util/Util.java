...
public class Util {
    ...
    public static void processAuthorization(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                String accessToken = JWT.create()
                        ...
                        .withClaim("roles", asList(user.getRole()))
                        .sign(algorithm);
            ...
            //Response entity should aware about the refresh token not found!
