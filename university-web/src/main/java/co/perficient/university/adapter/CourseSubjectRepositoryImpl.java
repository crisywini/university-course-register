...
public class CourseSubjectRepositoryImpl implements CourseSubjectRepository {
    ...
    public CourseSubject findById(Long id) {
        return courseSubjectJPARepository.findById(id).orElse(null);
    }
    ...
    @Override
    public CourseSubject update(Long id, CourseSubject newEntity) {
        CourseSubject courseSubject = findById(id);
        deleteById(id);
        return courseSubjectJPARepository.save(courseSubject.updateWith(newEntity));
    }
}
